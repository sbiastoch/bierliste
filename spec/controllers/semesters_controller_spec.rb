...
describe SemestersController do
  ...
  let(:valid_attributes) { { "start" => "2014-08-26" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved semester as @semester" do
        ...
        post :create, {:semester => { "start" => "invalid value" }}, valid_session
        assigns(:semester).should be_a_new(Semester)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested semester" do
        ...
        Semester.any_instance.should_receive(:update).with({ "start" => "2014-08-26" })
        put :update, {:id => semester.to_param, :semester => { "start" => "2014-08-26" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the semester as @semester" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Semester.any_instance.stub(:save).and_return(false)
        put :update, {:id => semester.to_param, :semester => { "start" => "invalid value" }}, valid_session
        assigns(:semester).should eq(semester)
      end
